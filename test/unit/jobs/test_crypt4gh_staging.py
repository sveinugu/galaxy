...
Key files used by these tests:
    ...
    test-data/crypt4gh/test.fastqsanger.c4gh — encrypted with user_key.pub
...
_TEST_C4GH_FILE = str(_C4GH_TEST_DIR / "test.fastqsanger.c4gh")
...
class TestBuildCommands:
    ...
    def _make_staged_input(self, idx: int) -> "StagedCrypt4GHInput":
        return StagedCrypt4GHInput(
            staged_path=f"/wd/_c4gh_stage/ds_{idx}/input.c4gh",
    ...
    def _make_staged_output(self, idx: int) -> "StagedCrypt4GHOutput":
        return StagedCrypt4GHOutput(
            ...
            encrypted_ext="fastqsanger.c4gh",
        )
...
class TestPlanCrypt4GHOutputStaging:
    ...
    def test_plan_output_staging_returns_eligible_output(self, tmp_path):
        ...
        assert staged.encrypted_ext == "fastqsanger.c4gh"
